...
if __name__ == "__main__":
    ...
    class JSONifiedState(EventScannerState):
        ...
        def process_event(self, block_when: datetime.datetime, event: AttributeDict) -> str:
            ...
            # Convert ERC-20 Approve event to our internal format
            args = event["args"]
            transfer = {
                "owner": args["owner"],
    ...
    def run():
        ...
        api_url = "https://mainnet.infura.io/v3/7e135dbc63904c30808f84ff52a92343"
